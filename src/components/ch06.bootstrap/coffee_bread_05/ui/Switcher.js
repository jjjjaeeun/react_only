...
function App({ mode, product, onSubmitInsert, onSubmitUpdate, onSubmitCategoryAdd, categories }) {
    ...
    switch (mode) {
        ...
        case 'get_update': // 상품 수정 화면으로 이동
            /* product는 이전에 입력했던 데이터로써, 수정하고자 하는 항목 */
            return <UpdateContent
                product={product}
                onSubmitUpdate={onSwitchUpdate}
